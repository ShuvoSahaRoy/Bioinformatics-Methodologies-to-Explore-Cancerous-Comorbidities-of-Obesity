...
setwd("D:/thesis work/code/result/result3")
...
path <- c("D:/thesis work/code/result/CD1_GSE69039_correspondence.txt")
files <- readtext(path)
...
do_id <-  c("DOID:1612","DOID:219","DOID:1380","DOID:263","DOID:9970",
            "DOID:1240","DOID:4159","DOID:3571" ,"DOID:10283")
do_ac <- c("BC","CC","EC","KC","OB","LC","SC","PC","LIC")
