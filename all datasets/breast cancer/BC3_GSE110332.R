...
url <- "ftp://ftp.ncbi.nlm.nih.gov/geo/series/GSE110nnn/GSE110332/matrix/"
...
gse <- getGEO(filename = "GSE110332_series_matrix.txt.gz")
...
write.csv2(subtable_result,"GSE110332_table.csv")
...
printGraph(CD_GOdata,resultFisher,firstSigNodes = 5, fn.prefix = "BC3_GSE110332", useInfo = "all", pdfSW = TRUE)
...
for (i in 1:length(terms))
{
  ...
  cat(term,"genes:",genes_term_2,"\n", append = TRUE, file = "BC3_GSE110332_correspondence.txt" )
}
