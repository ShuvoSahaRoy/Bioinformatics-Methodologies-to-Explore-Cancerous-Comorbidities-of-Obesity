...
setwd("C:/Users/SSROY/Desktop/bio/all datasets/liver cancer")
...
# url <- "ftp://ftp.ncbi.nlm.nih.gov/geo/series/GSE102nnn/GSE102079/matrix/"
...
# gse <- getGEO(filename = "GSE102079_series_matrix.txt.gz")


# 3. Download the GEO dataset only if not downloaded
url <- "ftp://ftp.ncbi.nlm.nih.gov/geo/series/GSE102nnn/GSE102079/matrix/"
filename <- "GSE102079_series_matrix.txt.gz"
...
d <- factor(c(rep('CD',243),rep('CTRL',14)))
...
write.csv2(subtable_result,"GSE102079_table.csv")
...
printGraph(CD_GOdata,resultFisher,firstSigNodes = 5, fn.prefix = "LC2_GSE102079", useInfo = "all", pdfSW = TRUE)
...
for (i in 1:length(terms))
{
  ...
  cat(term,"genes:",genes_term_2,"\n", append = TRUE, file = "LC2_GSE102079_correspondence.txt" )
}
