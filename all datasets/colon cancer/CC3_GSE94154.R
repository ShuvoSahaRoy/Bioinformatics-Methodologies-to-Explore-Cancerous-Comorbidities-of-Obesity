...
url <- "ftp://ftp.ncbi.nlm.nih.gov/geo/series/GSE94nnn/GSE94154/matrix/"
filename <- "GSE94154_series_matrix.txt.gz"
...
write.csv(subtable_result,"GSE94154_table.csv")
...
printGraph(AD_GOdata,resultFisher,firstSigNodes = 5, fn.prefix = "CC3_GSE94154", useInfo = "all", pdfSW = TRUE)
...
for (i in 1:length(terms))
{
  ...
  cat(term,"genes:",genes_term_2,"\n", append = TRUE, file = "CC3_GSE94154_correspondence.txt" )
}
