...
url <- "ftp://ftp.ncbi.nlm.nih.gov/geo/series/GSE92nnn/GSE92921/matrix/"
filename <- "GSE92921_series_matrix.txt.gz"
...
d <- factor(c(rep('AD',26),rep('CTRL',33)))
...
write.csv(subtable_result,"GSE92921_table.csv")
...
printGraph(AD_GOdata,resultFisher,firstSigNodes = 5, fn.prefix = "CC2_GSE92921", useInfo = "all", pdfSW = TRUE)
...
for (i in 1:length(terms))
{
  ...
  cat(term,"genes:",genes_term_2,"\n", append = TRUE, file = "CC2_GSE92921_correspondence.txt" )
}
