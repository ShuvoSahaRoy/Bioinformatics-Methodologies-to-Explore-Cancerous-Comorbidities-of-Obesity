...
url <- "ftp://ftp.ncbi.nlm.nih.gov/geo/series/GSE110nnn/GSE110425/matrix/"
...
gse <- getGEO(filename = "GSE110425_series_matrix.txt.gz")
...
write.csv(subtable_result,"GSE110425_table.csv")
...
printGraph(AD_GOdata,resultFisher,firstSigNodes = 5, fn.prefix = "CC4_GSE110425", useInfo = "all", pdfSW = TRUE)
...
for (i in 1:length(terms))
{
  ...
  cat(term,"genes:",genes_term_2,"\n", append = TRUE, file = "CC4_GSE110425_correspondence.txt" )
}
